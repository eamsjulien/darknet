...
extern void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen, char *labelc);
...
int main(int argc, char **argv)
{
    ...
    if (0 == strcmp(argv[1], "average")){
        ...
        char *labelc = argv[2];
        test_detector("cfg/coco.data", argv[2], argv[3], filename, thresh, .5, outfile, fullscreen, labelc);
